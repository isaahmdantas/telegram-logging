...
var TelegramLogging = /** @class */ (function () {
    ...
    TelegramLogging.prototype.iconMap = function () {
        return {
            DEBUG: '🚧',
            INFO: '💬',
            NOTICE: '🕵️‍♂️',
    ...
    TelegramLogging.prototype.sendMessage = function (type, message) {
        return __awaiter(this, void 0, void 0, function () {
            var icon, date, formattedMessage, response, error_1;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status !== 200) {
                            throw new Error("Falha ao enviar o log: ".concat(response.statusText));
                        }
                        return [2 /*return*/, response.data];
                    case 2:
                        error_1 = _a.sent();
                        throw new Error("Falha ao enviar o log: ".concat(error_1.message));
